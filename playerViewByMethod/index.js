...
export default class VlCPlayerViewByMethod extends Component {
    ...
    static defaultProps = {
        endingViewText: {
            endingText: 'Pemutaran video berakhir',
            reloadBtnText: 'Memuat Ulang',
        ...
        vipEndViewText: {
            ...
            boughtBtnText: 'Silakan tonton setelah pembelian',
        },
        chapterText: 'Chapter',
        autoplay: false,
        showAd: false,
    ...
    getNoNetInfoView = ()=> {
        ...
        return (
            <View
                ...
                <View style={styles.centerContainer}>
                    <Text style={styles.centerContainerText}>Jaringan tidak terhubung, silakan periksa pengaturan jaringan</Text>
                    <TouchableOpacity style={styles.centerContainerBtn} onPress={this._fetchNetWork} activeOpacity={1}>
                        <Icon name={'reload'} size={20} color="#fff" />
                        <Text style={styles.centerContainerBtnText}>Coba lagi</Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
